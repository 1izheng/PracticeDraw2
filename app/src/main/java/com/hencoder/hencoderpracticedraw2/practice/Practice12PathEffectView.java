...
public class Practice12PathEffectView extends View {
...

    {
        ...
        p.lineTo(40, 0);
        p.close();
        pathDashPathEffect = new PathDashPathEffect(p, 50,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect sumPathEffect = new SumPathEffect(dashEffect,discreatePathEffect);
        ...
        PathEffect composePathEffect = new ComposePathEffect(dashEffect,discreatePathEffect);
