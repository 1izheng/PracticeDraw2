...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap logobmp = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);

        Shader shader = new BitmapShader(bitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader1 = new BitmapShader(logobmp, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
